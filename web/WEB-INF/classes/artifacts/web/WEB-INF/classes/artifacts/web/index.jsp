...
<%
    if (session.getAttribute("hot_pic") == null) {
        response.sendRedirect("/web/indexPageServlet");
    }
%>
<div id="hotPic">
        ...
        <div class="swiper-wrapper">
            ...
            <c:forEach items="${sessionScope['hot_pic']}" var="item">
                <div class="swiper-item">
                    <img src="static/image/travel-images/large/<c:out value="${item.getPath()}"/>"
                         class="hot-img" alt="banner" onclick="alert('click')"/>
                </div>
            </c:forEach>
        </div>
    </div>
...
<div id="newPic" class="newPic">
    ...
    <c:forEach items="${sessionScope['new_pic']}" var="item">
        <div class="new">
            ...
            <a href="/web/detailPageServlet?imageId=<c:out value="${item.getImageId()}"/>">More</a>
        </div>
    </c:forEach>
