...
(function () {
    $.fn.extend({
        carousel: function a(d) {
            ...
            var h = d, k = h.width, f = h.height, r = h.speed, j = h.needPrevAndNextBtnGroup, v = h.needPagination;
            ...
            var o = {
                init: function q() {
                    ...
                    var w = $(".active").index();
                    var y = x.length;
                    c.find(".swiper-wrapper").css({
                        "width": y * k,
                        "transform": "translate3d(".concat(-parseInt(w) * k, "px, 0, 0)")
                    });
                    setTimeout(function () {
                        z.transitionToggle(true)
                    }, 100);
                    o.autoPlay()
                    ...
                    m = setTimeout(function () {
                        clearInterval(e);
                        var A = o, F = c.find(".swiper-item"), B = F.length, x = c.find(".active"), y = x.index(),
                            E = c.find(".swiper-wrapper"), z = $(".swiper-pagination-item"),
                            D = $(".swiper-pagination-item_active"), w = D.index();
                        var C = (B + 2) / 3;
                        if (y !== 1) {
                        ...
                        if (!w) {
                            z.removeClass("swiper-pagination-item_active").eq(C - 1).addClass("swiper-pagination-item_active")
                        } else {
                            D.removeClass("swiper-pagination-item_active").prev().addClass("swiper-pagination-item_active")
                        }
                        A.autoPlay()
                    }, 100)
                }, next: function i() {
                    ...
                    m = setTimeout(function () {
                        ...
                        if (w !== C - 1) {
                            D.removeClass("swiper-pagination-item_active").next().addClass("swiper-pagination-item_active")
                        } else {
                            z.removeClass("swiper-pagination-item_active").eq(0).addClass("swiper-pagination-item_active")
                        }
                        A.autoPlay()
                    }, 100)
                    ...
                    if (v) {
                        ...
                        var x = "";
                        for (var w = 0; w < y; w++) {
                            x += '<div class="swiper-pagination-item"></div>'
                        }
                        $(".swiper-pagination").html(x).find(".swiper-pagination-item").eq(0).addClass("swiper-pagination-item_active")
                    }
                }, transitionToggle: function l(w) {
                    if (w) {
                        c.find(".swiper-wrapper").addClass("swiper-wrapper-transition")
                    } else {
                        c.find(".swiper-wrapper").removeClass("swiper-wrapper-transition")
                    }
                }, autoPlay: function p() {
                    ...
                    var w = false;
                    var y = 0;
                    if (/Android|webOS|iPhone|iPod|BlackBerry/i.test(x)) {
                    } else {
