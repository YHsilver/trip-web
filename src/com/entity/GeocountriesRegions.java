...
@Entity
@Table(name = "geocountries_regions", schema = "travels" )
public class GeocountriesRegions {
    private String iso;
    ...
    @Basic
    @Column(name = "fipsCountryRegionCode")
    ...
    @Basic
    @Column(name = "PhoneCountryRegionCode")
    ...
    @Basic
    @Column(name = "CountryRegionDescription")
    ...
    public boolean equals(Object o) {
        ...
        GeocountriesRegions that = (GeocountriesRegions) o;
        return Objects.equals(iso, that.iso) &&
                ...
                Objects.equals(countryRegionName, that.countryRegionName) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(iso, fipsCountryRegionCode, iso3, isoNumeric, countryRegionName, capital, geoNameId, area, population, continent, topLevelDomain, currencyCode, currencyName, phoneCountryRegionCode, languages, postalCodeFormat, postalCodeRegex, neighbours, countryRegionDescription);
    }
}
